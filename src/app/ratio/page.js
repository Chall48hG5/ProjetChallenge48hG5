...
const mockData = {
  ...
  activites: [
    { nom: 'Distribution de provisions', date: '2024-04-01', lieu: 'Place centrale' },
    { nom: 'Point médical mobile', date: '2024-04-02', lieu: 'Place du marché' },
    { nom: 'Réunion d\'information', date: '2024-04-05', lieu: 'Mairie' },
    { nom: 'Centre d\'accueil temporaire', date: '2024-04-08', lieu: 'Gymnase municipal' },
  ],
};
